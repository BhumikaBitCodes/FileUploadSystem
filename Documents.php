    ...
    public function fetchDocuments()
    {
        ...
        if ($fetchstmt->rowCount() > 0) {
            while ($record = $fetchstmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                if ($record['documentType'] == "application/pdf") {
                ...
                } elseif ($record['documentType'] == "application/vnd.openxmlformats-officedocument.wordprocessingml.document") {
                    echo '<img src="./Assets/Imgs/Icons/docs.png">';
                } elseif ($record['documentType'] == "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet") {
                    echo '<img src="./Assets/Imgs/Icons/xls.png">';
                } elseif ($record['documentType'] == "application/vnd.ms-excel") {
                    ...
                    echo '
                        ...
                        <div class="card-buttons">
                           <button><a href="./edit-file.php?cid='.$record['documentId'].'">Edit</a></button>
